...
int main()
{
    ...
    //std::cout << "action= " << QBpNeuralNet.Recongnition(Read_data[9][100], actions, false) << std::endl;
    std::cout << "accuracy= " << QBpNeuralNet.RecognitionAccuracy(Input_data, Output_data, VideoTypeNumber * VideoNum * FrameNum, false) << std::endl;
